...
if not depsonly:
    print "Device %s not found. Attempting to retrieve device repository from ProjectLlama Github (https://github.com/ProjectLlama)." % device
...
def add_to_manifest(repositories):
    ...
    for repository in repositories:
        ...
        if exists_in_tree(lm, repo_name):
            print 'ProjectLlama/%s already exists' % (repo_name)
            continue
...
print "Repository for %s not found in the ProjectLlama Github repository list. If this is in error, you may need to manually add it to your local_manifest.xml." % device
