...
ifneq (,$(BOARD_KERNEL_LlamaDLINE_FACTORY_BOOT))
  RAMDISK_LlamaDLINE := --llamadline "$(BOARD_KERNEL_LlamaDLINE_FACTORY_BOOT)"
else
  RAMDISK_LlamaDLINE :=
endif
$(INSTALLED_FACTORY_RAMDISK_TARGET) : $(MKBOOTIMG) $(TARGET_RAMDISK_KERNEL) $(INSTALLED_FACTORY_RAMDISK_FS)
	...
	$(MKBOOTIMG) --kernel $(TARGET_RAMDISK_KERNEL) --ramdisk $(INSTALLED_FACTORY_RAMDISK_FS) \
            --base $(BOARD_KERNEL_BASE) $(RAMDISK_LlamaDLINE) --output $@
